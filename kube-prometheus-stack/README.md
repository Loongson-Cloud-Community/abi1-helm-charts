# 适配loongarch版本
# # 如果存在abi 12 混部的情况需要声明
#  #nodeSelector: {node.kubernetes.io/instance-abi: "1"}
    部分镜像目前在abi2.0缺少对应镜像，如果abi2需要使用需要查询下列镜像是否存在：(如果存在也请修改对应存在的版本号)
- grafana/grafana 10.4.1
- bats/bats 1.4.1
- curlimages/curl 7.83.1
- library/busybox 1.30.1
- kubernetes-sigs/k8s-sidecar 1.14.0
- kubesphere/kubectl v1.29.0
- prometheus/alertmanager 0.25.1
- prometheus-operator/admission-webhook 0.80.0
- ingress-nginx/kube-webhook-certgen 1.1.0
- prometheus/prometheus-operator 0.85.0
- prometheus/prometheus-config-reloader 0.85.0
- thanosio/thanos 0.30.0
- prometheus/prometheus 2.42.0
